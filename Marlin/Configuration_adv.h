...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  20, 160 }, { 280, 160 } }
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_4 "Lower Bed to Bottom"
  #define USER_GCODE_4 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "G90\nG0 Z300"

  #define USER_DESC_5 "Nozzle to Rear Right"
