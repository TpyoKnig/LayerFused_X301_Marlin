...
#define STRING_CONFIG_H_AUTHOR "(Buddy, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TpyoX301 2.0.6"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -20, 3.69, -2.300 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT 7
